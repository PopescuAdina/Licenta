...
<div>
	...
	<form method="post" action="adaugarecarteutilizatori.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>ISBN</th>
			...
			<tr>
				<th>Autor</th>
				<td><input type="text" name="autor" required  pattern="[a-zA-Z'-'\s]*" title="Nume invalid.Acest câmp acceptă doar litere. "></td>
			...
			<tr>
				<th>Limba</th>
				<td><input type="text" name="Limba" required  pattern="[a-zA-Z'-'\s]*" title="Acest câmp acceptă doar litere. "></td>
			</tr>
			<tr>
				<th>Categorie</th>
				<td><input type="text" name="Categorie" required pattern="[a-zA-Z'-'\s]*" title="Acest câmp acceptă doar litere. "> <p> *Categoria trebuie sa fie utilizator</p></td>
			</tr>
			<tr>
				<th>Descriere</th>
		...
		<input type="reset" value="Sterge" class="btn btn-default">
	</form>
